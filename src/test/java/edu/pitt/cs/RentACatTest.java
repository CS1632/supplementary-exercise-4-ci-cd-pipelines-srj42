...
public class RentACatTest {
	...
	public void testGetCatNullNumCats0() {
		// TODO
		assertNull("Get cat should return nothing", r.getCat(2));
	}
	...
	public void testGetCatNumCats3() {
		...
		assertNotNull("R should not be null", r.getCat(2));
		assertEquals("Should be 2", 2, r.getCat(2).getId());
	}
	...
	public void testCatAvailableFalseNumCats0() {
		// TODO
		assertFalse("Should be false", r.catAvailable(2));
	}
	...
	public void testCatAvailableTrueNumCats3() {
		...
		//r.rentCat(3); //shouldnt care
		//Mockito.when(c3.getRented()).thenReturn(true); //dont care
		Mockito.when(c2.getRented()).thenReturn(false);
		assertTrue("Should be true", r.catAvailable(2));
	}
	...
	public void testCatAvailableFalseNumCats3() {
		...
		assertFalse("Cat is not available because rented", r.catAvailable(2));
	}
	...
	public void testCatExistsFalseNumCats0() {
		// TODO
		assertFalse("Cat 2 doesn't exist.", r.catExists(2));
	}
	...
	public void testCatExistsTrueNumCats3() {
		...
		assertTrue("Cat 2 Exists is True", r.catExists(2));
	}
	...
	public void testListCatsNumCats0() {
		// TODO	
		assertEquals("An empty string", "", r.listCats());
	}
	...
	public void testListCatsNumCats3() {
		...
		assertEquals("List all three cats info", "ID 1. Jennyanydots\nID 2. Old Deuteronomy\nID 3. Mistoffelees\n", r.listCats());
	}
	...
	public void testRentCatFailureNumCats0() {
		// TODO
		assertFalse("Cat 2 is not rented", r.rentCat(2));
	...
	public void testRentCatFailureNumCats3() {
		...
		assertFalse("No Cat is rented", r.rentCat(2));
	...
	public void testReturnCatFailureNumCats0() {
		// TODO
		assertFalse("No cat should be returned", r.returnCat(2));
	}
	...
	public void testReturnCatNumCats3() {
		...
		Mockito.when(c2.getRented()).thenReturn(true);
		assertTrue("Call return cat on 2", r.returnCat(2));
	}
}
